...
# hyperparameters
batch_size = 64 // 8 # how many independent sequences will we process in parallel?
...
with open("GPT/data/dataset.txt", "r", encoding='utf-8') as f:
    text = f.read()
...
vocab_size = max(tokens) + 1    # 100255
